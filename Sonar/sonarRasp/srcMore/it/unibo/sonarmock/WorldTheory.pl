%==============================================
% WorldTheory.pl for actor sonarmock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarmock).	%%old version (deprecated)
actorobj(qatusonarmock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarmock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarmock" ). 
...
%-------------------------------------------------
%  User static rules about sonarmock
%------------------------------------------------- 
p( 80,sonar1).
p( 70,sonar1).
p( 80,sonar1).
