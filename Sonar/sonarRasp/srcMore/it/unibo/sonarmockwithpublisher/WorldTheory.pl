%==============================================
% WorldTheory.pl for actor sonarmockwithpublisher
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarmockwithpublisher).	%%old version (deprecated)
actorobj(qatusonarmockwithpublisher).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarmockwithpublisher
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarmockwithpublisher" ). 
...
%-------------------------------------------------
%  User static rules about sonarmockwithpublisher
%------------------------------------------------- 
p( 80,sonar1).
p( 70,sonar1).
p( 80,sonar1).
