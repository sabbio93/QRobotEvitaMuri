%==============================================
% WorldTheory.pl for actor radasourcemock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadasourcemock).	%%old version (deprecated)
actorobj(qaturadasourcemock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radasourcemock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radasourcemock" ). 
...
%-------------------------------------------------
%  User static rules about radasourcemock
%------------------------------------------------- 
p( 80,0).
p( 80,30).
p( 80,60).
