%==============================================
% WorldTheory.pl for actor sonarraspwithpublisher
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarraspwithpublisher).	%%old version (deprecated)
actorobj(qatusonarraspwithpublisher).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarraspwithpublisher
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarraspwithpublisher" ). 
...
%-------------------------------------------------
%  User static rules about sonarraspwithpublisher
%------------------------------------------------- 
/*
------------------------------------------------------------------------
