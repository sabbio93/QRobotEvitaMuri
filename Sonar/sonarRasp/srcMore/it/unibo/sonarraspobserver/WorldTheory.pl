%==============================================
% WorldTheory.pl for actor sonarraspobserver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarraspobserver).	%%old version (deprecated)
actorobj(qatusonarraspobserver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarraspobserver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarraspobserver" ). 
...
%-------------------------------------------------
%  User static rules about sonarraspobserver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
