%==============================================
% WorldTheory.pl for actor radaranothersourcemock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadaranothersourcemock).	%%old version (deprecated)
actorobj(qaturadaranothersourcemock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radaranothersourcemock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radaranothersourcemock" ). 
...
%-------------------------------------------------
%  User static rules about radaranothersourcemock
%------------------------------------------------- 
p( 40,0).
p( 40,30).
p( 40,60).
...
p( 40,150).
p( 40,180).
evalSizeData:-bagof( A,p( D,A),L),length( L,N),assign( datalength,N),getVal( datalength,X),actorPrintln( sizedataaaaaa( X)).
sizeData( N):-bagof( A,p( D,A),L),length( L,N).
/*
------------------------------------------------------------------------
