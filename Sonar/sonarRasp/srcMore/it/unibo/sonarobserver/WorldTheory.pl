%==============================================
% WorldTheory.pl for actor sonarobserver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarobserver).	%%old version (deprecated)
actorobj(qatusonarobserver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarobserver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarobserver" ). 
...
%-------------------------------------------------
%  User static rules about sonarobserver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
