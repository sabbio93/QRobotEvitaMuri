%==============================================
% WorldTheory.pl for actor sonaraunity
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonaraunity).	%%old version (deprecated)
actorobj(qatusonaraunity).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonaraunity
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonaraunity" ). 
...
%-------------------------------------------------
%  User static rules about sonaraunity
%------------------------------------------------- 
/*
------------------------------------------------------------------------
