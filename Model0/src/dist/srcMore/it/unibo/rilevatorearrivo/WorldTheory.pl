%==============================================
% WorldTheory.pl for actor rilevatorearrivo
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturilevatorearrivo).	%%old version (deprecated)
actorobj(qaturilevatorearrivo).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor rilevatorearrivo
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of rilevatorearrivo" ). 
...
%-------------------------------------------------
%  User static rules about rilevatorearrivo
%------------------------------------------------- 
