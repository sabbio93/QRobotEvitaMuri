%==============================================
% WorldTheory.pl for actor sonarbfisico
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarbfisico).	%%old version (deprecated)
actorobj(qatusonarbfisico).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarbfisico
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarbfisico" ). 
