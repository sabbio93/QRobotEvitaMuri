%==============================================
% WorldTheory.pl for actor sonarrasp
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarrasp).	%%old version (deprecated)
actorobj(qatusonarrasp).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarrasp
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarrasp" ). 
...
%-------------------------------------------------
%  User static rules about sonarrasp
%------------------------------------------------- 
