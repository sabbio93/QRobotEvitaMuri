%==============================================
% WorldTheory.pl for actor sonarb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarb).	%%old version (deprecated)
actorobj(qatusonarb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarb" ). 
