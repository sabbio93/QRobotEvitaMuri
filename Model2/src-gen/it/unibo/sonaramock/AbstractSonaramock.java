...
public abstract class AbstractSonaramock extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractSonaramock(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/sonaramock/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/sonaramock/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		println( temporaryStr );  
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine, "robotDetected(Sonar,Distanza)","robotDetected(sonara,d(20))", guardVars ).toString();
