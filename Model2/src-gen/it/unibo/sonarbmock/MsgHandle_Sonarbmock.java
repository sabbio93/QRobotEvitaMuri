...
public class MsgHandle_Sonarbmock extends QActor implements IMsgQueue{ 
	protected AsynchActionResult aar = null;
	protected boolean actionResult = true;
	protected alice.tuprolog.SolveInfo sol;
  	protected Vector<QActorMessage> msgQueue = new Vector<QActorMessage>();

	public MsgHandle_Sonarbmock(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
	...
	//Called by MsgHandle_Sonarbmock_ctrl
