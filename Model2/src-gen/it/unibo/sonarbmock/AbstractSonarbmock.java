		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		println( temporaryStr );  
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine, "robotDetected(Sonar,Distanza)","robotDetected(sonarb,30)", guardVars ).toString();
	    		...
	    		temporaryStr = "\"invio event stop\"";
	    		println( temporaryStr );  
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine, "robotDetected(Sonar,Distanza)","robotDetected(sonarb,20)", guardVars ).toString();
	    		emit( "robotDetected", temporaryStr );
	    break;
	    }//while
	    return returnValue;
