...
public class MsgHandle_Sonarbunity extends QActor implements IMsgQueue{ 
	protected AsynchActionResult aar = null;
	protected boolean actionResult = true;
	protected alice.tuprolog.SolveInfo sol;
  	protected Vector<QActorMessage> msgQueue = new Vector<QActorMessage>();

	public MsgHandle_Sonarbunity(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
	...
	//Called by MsgHandle_Sonarbunity_ctrl
