%==============================================
% WorldTheory.pl for actor sonaramock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonaramock).	%%old version (deprecated)
actorobj(qatusonaramock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonaramock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonaramock" ). 
...
%-------------------------------------------------
%  User static rules about sonaramock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
