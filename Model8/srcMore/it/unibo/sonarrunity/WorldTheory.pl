%==============================================
% WorldTheory.pl for actor sonarrunity
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarrunity).	%%old version (deprecated)
actorobj(qatusonarrunity).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarrunity
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarrunity" ). 
...
%-------------------------------------------------
%  User static rules about sonarrunity
%------------------------------------------------- 
/*
------------------------------------------------------------------------
