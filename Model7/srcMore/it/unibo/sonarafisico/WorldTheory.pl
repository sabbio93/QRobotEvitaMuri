%==============================================
% WorldTheory.pl for actor sonarafisico
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarafisico).	%%old version (deprecated)
actorobj(qatusonarafisico).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarafisico
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarafisico" ). 
...
%-------------------------------------------------
%  User static rules about sonarafisico
%------------------------------------------------- 
