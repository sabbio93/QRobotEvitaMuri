%==============================================
% WorldTheory.pl for actor mockstart
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumockstart).	%%old version (deprecated)
actorobj(qatumockstart).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mockstart
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mockstart" ). 
...
%-------------------------------------------------
%  User static rules about mockstart
%------------------------------------------------- 
/*
------------------------------------------------------------------------
