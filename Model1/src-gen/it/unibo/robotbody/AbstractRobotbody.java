...
class QaRobotActor extends it.unibo.qactor.robot.RobotActor{
	public QaRobotActor(
		...
		super(name, ctx, "./srcMore/it/unibo/robotbody/plans.txt", worldTheoryPath,
		outEnvView, it.unibo.qactor.robot.RobotSysKb.setRobotBase(ctx, baserobot) , defaultPlan);
	}
}

public class AbstractRobotbody extends QaRobotActor { 
...
protected IActorAction  action;
	...
	public AbstractRobotbody(String actorId, QActorContext myCtx, IOutputEnvView outEnvView ,String baserobot)  throws Exception{
		super(actorId, myCtx,  
		"./srcMore/it/unibo/robotbody/WorldTheory.pl",
		setTheEnv( outEnvView ) ,baserobot , "init");		
		this.planFilePath = "./srcMore/it/unibo/robotbody/plans.txt";
	...
	*/
    ...
    while(true){
    	...
    	nPlanIter++;
    		...
    		if( ! planUtils.switchToPlan("waitMindCommand").getGoon() ) break;
    break;
    }//while
    return returnValue;
    }catch(Exception e){
    ...
    public boolean waitMindCommand() throws Exception{	//public to allow reflection
    try{
    	int nPlanIter = 0;
    	//curPlanInExec =  "waitMindCommand";
    	boolean returnValue = suspendWork;		//MARCHH2017
    while(true){
    	curPlanInExec =  "waitMindCommand";	//within while since it can be lost by switchlan
    	nPlanIter++;
    		if( ! checkInMsgQueue() ){
    			//ReceiveMsg
    		...
    		//onMsg
    		if( currentMessage.msgId().equals("mindcommand") ){
    			String parg = "";
    			/* SwitchPlan */
    			parg =  updateVars(  Term.createTerm("mindcommand(Type)"), Term.createTerm("mindcommand(goforward)"), 
    ...
    return returnValue;
       ...
       //println( getName() + " plan=waitMindCommand WARNING:" + e.getMessage() );
       QActorContext.terminateQActorSystem(this); 
       return false;  
    }
    }
    ...
    while(true){
    	...
    	nPlanIter++;
    		...
    		println( temporaryStr );  
    		//forward
    		//if( ! execRobotMove("goForward","forward",60,0,600000, "stop" , "fermaRobot") ) break;
    		    aar = execRobotMove("goForward","forward",60,0,600000, "stop" , "fermaRobot");
    		    if( aar.getInterrupted() ){
    		    	curPlanInExec   = "goForward";
    		    	if( ! aar.getGoon() ) break;
    		    } 			
    ...
    */
    protected void initSensorSystem(){		
    	try {
    		String goal = "consult( \"./src/it/unibo/robotbody/sensorTheory.pl\" )";
    ...
    */
    protected void addSensorObservers(){
    	for (ISensor<?> sensor : Configurator.getInstance().getSensors()) {
    		//println( "robotbody sensor= "  + sensor.getDefStringRep() );
    		//println( "robotbody sensor class= "  + sensor.getClass().getName() );
