...
public class MsgHandle_Mocsonarb extends QActor implements IMsgQueue{ 
	protected AsynchActionResult aar = null;
	protected boolean actionResult = true;
	protected alice.tuprolog.SolveInfo sol;
  	protected Vector<QActorMessage> msgQueue = new Vector<QActorMessage>();

	public MsgHandle_Mocsonarb(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
	...
	//Called by MsgHandle_Mocsonarb_ctrl
