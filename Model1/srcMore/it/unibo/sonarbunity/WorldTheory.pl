%==============================================
% WorldTheory.pl for actor sonarbunity
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarbunity).	%%old version (deprecated)
actorobj(qatusonarbunity).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarbunity
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarbunity" ). 
...
%-------------------------------------------------
%  User static rules about sonarbunity
%------------------------------------------------- 
/*
------------------------------------------------------------------------
