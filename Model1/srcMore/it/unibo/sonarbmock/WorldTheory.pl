%==============================================
% WorldTheory.pl for actor sonarbmock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarbmock).	%%old version (deprecated)
actorobj(qatusonarbmock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarbmock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarbmock" ). 
...
%-------------------------------------------------
%  User static rules about sonarbmock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
