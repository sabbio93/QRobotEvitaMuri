<<<<<<< HEAD
%==============================================
% WorldTheory.pl for actor mocsonara
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumocsonara).	%%old version (deprecated)
actorobj(qatumocsonara).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mocsonara
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mocsonara" ). 
...
%-------------------------------------------------
%  User static rules about mocsonara
%------------------------------------------------- 
/*
------------------------------------------------------------------------
...
:- initialization(initialize).
>>>>>>> branch 'develop' of https://github.com/sabbio93/QRobotEvitaMuri.git
